...
### `deployment/`
Contains files used to deploy the contract. For more details on how to deploy the contract using Hardhat, you can check [this tutorial](https://medium.com/your-medium-article-link](https://medium.com/@ijusttookadnatest/how-to-deploy-a-smart-contract-with-hardhat-2024-9abd44080029)) I created.
